...
public class online_med_Payment_page extends AppCompatActivity implements View.OnClickListener {
    Spinner bank_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.online_med_payment_page);
    ...
    public void onClick(View view) {
        ...
        if( bank_ac_no.length() == 0 ) {
            ...
            String url = "http://" + hu + ":5000/patient_med_payment";
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                    Intent i = new Intent(getApplicationContext(), requestSuccessFilemed.class);
                                    startActivity(i);

                                    Toast.makeText(online_med_Payment_page.this, "Done..!!", Toast.LENGTH_SHORT).show();
